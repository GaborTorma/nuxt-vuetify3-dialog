...
import { createDialog, notifyInfo, notifySuccess, createBottomSheet } from 'vuetify3-dialog'
...
<template>
	<v-app>
		...
		<v-layout class="d-flex flex-column mt-6 align-center justify-center pa-10" fluid>
			<v-btn class="ma5" color="primary" @click="showNotify"> notify </v-btn>
		</v-layout>
		<v-layout class="d-flex flex-column mt-6 align-center justify-center pa-10" fluid>
			<v-btn class="ma5" color="primary" @click="showWarnDialog"> dialog </v-btn>
		</v-layout>
		<v-layout class="d-flex flex-column mt-6 align-center justify-center pa-10" fluid>
			<v-btn class="ma5" color="primary" @click="showBottomSheet"> bottom sheet </v-btn>
		</v-layout>
	</v-app>
</template>
